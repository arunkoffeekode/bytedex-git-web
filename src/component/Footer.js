                        ...
                        <div className="col-lg-2 col-md-12 col-sm-12 col-xl-2">
                            <div className="footer-links-1">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Marketing Cooperation</a></li>
                    ...
                    <div className="row mt-2">
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12 col-xl-6'>
                            <div class="button-right">
                                <form>
                                    <select>
                                        <option value="0" selected="">English/USD</option>
                    ...
                    <div className="row">
                        <div className='col-lg-12 col-md-12 col-sm-12 col-xl-12'>
                            <div className='copy-right'>
                                <div className='text'>Copyright 2022 © Designs. All Rights Reserved</div>
                            </div>
                        </div>
                    </div>
                </div>
