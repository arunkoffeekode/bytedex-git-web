                ...
                <div className='row'>
                    <div className='col-lg-12 col-md-12 col-xl-12 col-sm-12'>
                        <div className='verification-blue-box'>
                            ...
                            <div className='rlt'>
                                <button type='button' className='level'>Level 3</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className='level-box'>
                            <div className='level-step'>
                                <ul>
                                    ...
                                    <li>
                                        <Link to='/accountVerification3'><button type='button' className='step active'> <img src='images/level.png'></img>Level 3</button></Link>
                                    </li>
                                </ul>
                            </div>
                            <form>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <h4 >Address Proof</h4>
                                        <h6>Image file format must be jpg or png, file size cannot exceed 4 MB. Image should be clearly visible! Note should be clearly readable! </h6>
