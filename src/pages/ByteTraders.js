                                    ...
                                    <div className='col-lg-12 col-md-12 col-xl-12 col-sm-12'>
                                        <div className='market-tab12'>
                                            <ul id="myTab1" role="tablist" class="nav nav-tabs nav-pills ">
                                                <li class="nav-item">
                                                    <a id="description-tab" data-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="false" class="nav-link active show">Shared Strategies</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review" aria-selected="true" class="nav-link">My Strategies</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a id="fiat-tab" data-toggle="tab" href="#fiat" role="tab" aria-controls="fiat" aria-selected="false" class="nav-link">Subscribed Strategies</a>
                                                </li>
                                            </ul>
                                            <div className='right-btn'>
                                                <button type='button' className='strategy'>Create Strategy</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
