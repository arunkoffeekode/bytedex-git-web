                                    ...
                                    <div id="description" role="tabpanel" aria-labelledby="description-tab" class="tab-pane fade active show">
                                        <form>
                                            <div class="form-row">
                                                ...
                                                <h4 className='mb-2'>Use a valid government-issued document</h4>
                                                <h6>Only the following documents listed below will be accepted, all other documents will be rejected.</h6>
                                                <div class="form-group col-md-12">
                                                    <select name="" id="" class="form-control">
                                                        <option value="1" selected="">Government-Issued ID Card</option>
                                                        <option value="1">Government-Issued ID Card</option>
                                                        <option value="1">Government-Issued ID Card</option>
                                                    </select>
                                                </div>
                                                <h6 className='mb-2'>Upload a Photo of ID  </h6>
                                                <p className='photo'>File size must be between 10KB and 5120KB in ..jpg/.jpeg/.png format.</p>
