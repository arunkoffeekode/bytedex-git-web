                        ...
                        <div className='col-lg-12 col-md-12 col-sm-12 col-xl-12'>
                            <div className='open-button'>
                                ...
                                <li><Link to='/account' href='#' className='open-btn'>Account </Link></li>
                                    ...
                                    <li><Link to='/Volume' href='#' className='active'>Volume Discount</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <section className='security pt-0'>
                <div className='container-fluid'>
                    <div className='row'>
                        ...
                        <div className='col-lg-12 col-md-12 col-sm-12 col-xl-12'>
                            <div className='para'>
                                <p>Every day your trading volume from the last 30 days are evalulated. You will recieve<br /> a trading fee discount based on your past trading volume.</p>
                            </div>
                        </div>
                            ...
                            <div className='start-table'>
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr className='active'>
                                            <td>
                                                <button type='button' className='tier'>Tier 0  <img src='images/level.png'></img></button>
                                            </td>
                                            <td>0 BTC</td>
                                            <td>5%</td>
                                        </tr>
